...
//         ),
//         content: const Text(
//           "Unblocking may expose your child to risk.\nAre you sure?",
//           textAlign: TextAlign.center,
//         ),
//         actions: [
//           Row(
//             mainAxisAlignment: MainAxisAlignment.center,
//             children: [
//               _buildUnifiedButton("Yes, Unblock", Colors.red, Colors.white, () {
//                 Navigator.pop(context);
//                 _unblockNotification(notif['notification_id']);
//               }),
//               const SizedBox(width: 10),
...
//         Uri.parse('http://192.168.2.19:3000/notifications/$notificationId'),
//         headers: {"Authorization": "Bearer $token"},
//       );
      ...
      body: _isLoading
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Dismissible(
                  key: ValueKey(id),
                  direction: DismissDirection.startToEnd, // من اليسار لليمين
